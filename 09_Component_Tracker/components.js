...
window.COMPONENTS = [
  {
    ...
    "dims_mm": "cell TBD (drives pack layout)",
    "mass_kg": "~2600 (pack cells)",
    "qty": "~ per kWh",
    "status": "researching",
    "candidates": [
      {
        "supplier": "CATL",
        "product": "Naxtra",
        "note": "mass prod Dec'25; -50C charge; 10k cycle; automotive"
      },
      {
        "supplier": "HiNa Battery",
        "product": "NaCR32140/blade",
        "note": "China; EV+ESS cells"
      },
      {
        "supplier": "Hithium",
        "product": "Na-ion ESS",
        "note": "~20k cycle ESS cell"
      },
      {
        "supplier": "Faradion (Reliance)",
        "product": "Na-ion",
        "note": "UK/India; 0V-safe pioneer"
      },
      {
        "supplier": "Natron",
        "product": "Prussian-blue",
        "note": "US; very high power but low energy density - likely NOT for a big pack"
      }
    ],
    "selected": "",
