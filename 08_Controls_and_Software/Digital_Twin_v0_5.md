...
- **Pack** — 330 kWh, SOC in [5 %, 100 %], charge/discharge each step.
...
Headline: **the 330 kWh pack is so large that most normal weeks never start the genset** — the CHP is a true backstop, not a daily crutch. (See `digital_twin_results.png`.)
...
| **5** Remote mountain arrival, no charger | 180 mi + pass, land 40 mi from help | **VIOLATION (expected)** — below ideal reserve for ~4 h until CHP/solar recover |
